// src/pages/EditarClientePage.tsx
    ...
    const fetchCliente = async () => {
      ...
      try {
        ...
        setModalError({
          ...
          message: err?.response?.data?.message || "No se pudo obtener la información del cliente. Intenta nuevamente.",
        });
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setModalError({
        ...
        message: err?.response?.data?.message || "Ocurrió un problema al actualizar el cliente. Intenta nuevamente.",
      });
    } finally {
      setSubmitting(false);
    }
